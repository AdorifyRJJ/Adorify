<template>
    <div class="section">
      ...
      <div class="selectPlaylists">
        <div class="bgroup1">
          <button class="btn" @click="getMyPlaylists">My Spotify Library</button>
          <button class="btn" @click="getPublicPlaylists">Public Library</button>
        </div>
  
        <div v-if="!viewingMine" class="bgroup2">
          <button class="dropdown" @click="getMostLiked">Most liked</button>
      ...
      <div v-else>
        ...
        <div>
          ...
          <button v-if="currPlaylists.next" @click="nextPage">next page</button>
        </div>
      </div>
    </div>
  </template>
