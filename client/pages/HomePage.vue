<template>
  <main class="center">
    ...
    <div class="center" v-if="!sessionStarted">
      <div class="selector">
        <div class="selectorItem">
          ...
          <div class="right gr20"><input v-model="focusTime" /> min</div>
        </div>
        <div class="selectorItem">
          <div class="left gr20">Break Time</div>
          <div class="right gr20"><input v-model="breakTime" /> min</div>
        </div>
        <div class="selectorItem">
      ...
      <div v-else class="gr20 hint">
        Go to the Playlists page and like playlists to use for your study
        sessions!
      </div>
      <div class="bottomDiv">
    ...
    <div class="center" v-else>
      ...
      <div class="wh20b intervals">
        {{ this.currInterval }} / {{ this.intervals }}
      </div>
